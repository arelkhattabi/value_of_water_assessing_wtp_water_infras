...
# } else {
#   
#   # DID NOT UPDATE THESE YET FOR AR TO RUN -- AT
#   survey_2021 <- readxl::read_xlsx(paste0("/Users/",Sys.getenv("USER"),"/Library/CloudStorage/Box-Box/VoW Analysis/VoW data March 2024/2021.xlsx")) %>% 
#     dplyr::select(QB, Q1B, Q1C, Q3, Q4, Q5,Q6, Q7, Q8, Q10, Q14, Q15,Q16A, Q16B, Q16C, Q16E, Q16F, Q17, Q18, Q19, Q20,Q21A, Q21B, Q21C, Q21D, Q22, Q24, Q28, REGION, CENSUS_DIV) %>% 
#     rename(age = QB,
#            trust_gov_state = Q1B,
#            trust_gov_local = Q1C,
#            trust_drink_water_home = Q3,
...
#    
#   
#   survey_2022 <- readxl::read_xlsx(paste0("/Users/",Sys.getenv("USER"),"/Library/CloudStorage/Box-Box/VoW Analysis/VoW data March 2024/2022.xlsx")) %>% 
#     dplyr::select(QB, Q1B, Q1C, Q3, Q4, Q5,Q6, Q7, Q8, Q10, Q16, Q17, Q18, Q19, Q20A, Q20B, Q20C, Q20E, Q20F, Q20G, Q20H, Q21,Q22, Q23, Q24, Q25A, Q25B, Q25C, Q25D, Q26, Q27, Q29, Q33, REGION, CENSUS_DIV) %>% 
#     rename(age = QB,
#            trust_gov_state = Q1B,
#            trust_gov_local = Q1C,
#            trust_drink_water_home = Q3,
...
#            water_svc_qual_dirty = Q20E,
#            water_svc_qual_taste = Q20F,
#            water_svc_qual_extreme_weather = Q20G,
#            water_svc_qual_shutoff = Q20H,
#            wtp_rate_increase_qual_reduce_pollution = Q21,
#            wtp_rate_increase_qual_drinking_trust_water_safety = Q22,
#            wtp_rate_increase_qual_taste_smell = Q23,
#            wtp_rate_increase_qual_prevent_shutoff = Q24,
...
#    
#   
#   survey_2023 <- readxl::read_xlsx(paste0("/Users/",Sys.getenv("USER"),"/Library/CloudStorage/Box-Box/VoW Analysis/VoW data March 2024/2023.xlsx")) %>% 
#     dplyr::select(QB, Q1b, Q1c, Q3, Q4, Q5,Q6, Q7, Q8, Q10, Q16, Q17, Q18, Q19, Q20a, Q20b, Q20c, Q20e, Q20f, Q20g, Q20h, Q21, Q22, Q23, Q24, Q25a, Q25b, Q25c, Q25d, Q26, Q27, Q29, Q33, REGION, CENSUS) %>% 
#     rename(age = QB,
#            CENSUS_DIV = CENSUS,
#            trust_gov_state = Q1b,
#            trust_gov_local = Q1c,
...
# }
#  
# AT: went back through and recoded DK/NA as a category. Dropping too much data otherwise.
